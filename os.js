...
function addToList2() {
    var at = document.getElementById("newat2").value;
    var bt = document.getElementById("newbt2").value;
    if (isNaN(parseInt(at)) && isNaN(parseInt(bt))) {
        window.alert("Please enter valid inputs");
        return;
    }
...
function showOutput(flag) {
    ...
    gt.innerHTML = "";
    gt.setAttribute("style", "width: 100%; height: 100px; position: relative; border: .5px solid black;");
